...
contract ForwardingInitiative is IInitiative {
    IGovernance private _governance;
    IERC20 private _revenueToken;
    address private _receiver;

    constructor(address governance, address revenueToken, address receiver) {
        require(revenueToken != address(0), "InitialInitiative: revenue-token-cannot-be-zero");
    ...
    modifier onlyGovernance() {
        require(msg.sender == address(_governance), "BribeInitiative: invalid-sender");
        _;
    }
